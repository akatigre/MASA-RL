...
experiment_name=${DATA_NAME}-Qwen3-${MODEL_SIZE}-Base-MASAGRPO-MAX-${MAX_RESPONSE_LENGTH}
python3 -m verl.trainer.main_ppo \
    --config-path="${BASE_DIR}/masa_train/config" \
    --config-name='masa_grpo' \
    ...
    +actor_rollout_ref.rollout.meta_cog_n=16 \
